...
func Handler[Req teavalid.Validator[T], T any, Res *U, U any](
...
func ErrorHandler(s *teaserver.Server) func(r *teaserver.Request, err teaerrors.Error) {
	logger := tealog.New(
		tealog.NewRecordText,
		tealog.NewWriterCloserFile(tealog.FileDir, "http-error"),
	)
	s.Loggers(logger)
	return func(r *teaserver.Request, err teaerrors.Error) {
